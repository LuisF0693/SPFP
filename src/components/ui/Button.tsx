 ...
 * WCAG 2.1 AA: aria-label for icon-only, aria-busy for loading, focus indicators, 44px min touch target
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const effectiveAriaLabel = ariaLabel || (isIconOnly ? title || 'Button' : undefined);
