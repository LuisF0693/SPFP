...
- [ ] FinancialDashboard renderiza corretamente
- [ ] 3 cards de métricas com formatação correta
- [ ] Gráfico Receita vs Despesa com 6 meses de dados
- [ ] Gráfico Fluxo de Caixa com projeção 3 meses
- [ ] Listas Contas a Pagar e Receber com cores de vencimento
- [ ] DRE simplificado com cálculos corretos
- [ ] Filtro por período funciona (atualiza gráficos/listas)
- [ ] Date picker customizado se período = "Customizado"
- [ ] Modal/drawer responsivo (mobile/tablet/desktop)
- [ ] Sem console errors
...
- [ ] src/components/corporate/FinancialDashboard.tsx
- [ ] src/components/corporate/MetricsCards.tsx
- [ ] src/components/corporate/RevenueVsExpenseChart.tsx
- [ ] src/components/corporate/CashFlowChart.tsx
- [ ] src/components/corporate/PayablesList.tsx
- [ ] src/components/corporate/ReceivablesList.tsx
- [ ] src/components/corporate/DREStatement.tsx
- [ ] src/components/corporate/PeriodFilter.tsx
