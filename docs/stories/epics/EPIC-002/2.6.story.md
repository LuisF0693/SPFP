...
- [ ] SalesDashboard renderiza corretamente
- [ ] Pipeline com 5 estágios e cores distintas
- [ ] Botão "+ Novo Lead" abre form
- [ ] LeadForm com 8 campos, validação básica
- [ ] Drag & drop funciona (desktop e mobile)
- [ ] Valor total por estágio atualiza
- [ ] Taxa de conversão calcula e exibe corretamente
- [ ] Meta vs realizado com barra de progresso
- [ ] Clique em lead abre LeadDetails
- [ ] Modal detalhes com botões Editar/Mudar Estágio/Deletar
...
- [ ] src/components/corporate/SalesDashboard.tsx
- [ ] src/components/corporate/SalesPipeline.tsx
- [ ] src/components/corporate/PipelineColumn.tsx
- [ ] src/components/corporate/LeadCard.tsx
- [ ] src/components/corporate/LeadForm.tsx
- [ ] src/components/corporate/LeadDetails.tsx
- [ ] src/components/corporate/ConversionRates.tsx
- [ ] src/components/corporate/GoalTracker.tsx
