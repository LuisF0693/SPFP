...
- [ ] OperationalDashboard renderiza corretamente
- [ ] Kanban com 3 colunas funcionais
- [ ] Botão "+ Nova Tarefa" abre form
- [ ] TaskForm com 5 campos, validação básica
- [ ] Drag & drop funciona (desktop e mobile)
- [ ] Filtro por prioridade funcional
- [ ] Contadores atualizando corretamente
- [ ] Datas de vencimento com cores corretas
...
- [ ] src/components/corporate/OperationalDashboard.tsx
- [ ] src/components/corporate/KanbanBoard.tsx
- [ ] src/components/corporate/KanbanColumn.tsx
- [ ] src/components/corporate/TaskCard.tsx
- [ ] src/components/corporate/TaskForm.tsx
- [ ] src/components/corporate/PriorityFilter.tsx
- [ ] src/data/mockOperational.ts
